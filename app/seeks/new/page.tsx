    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm mt-1">
          Click your pickup point then destination — drivers going your way will find you
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-white border rounded-xl p-5">
          ...
          <MapPicker
            ...
            onChange={(o, d) => { setOrigin(o); setDestination(d) }}
            height="320px"
          />
        </div>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
          <p className="text-blue-700 text-sm">
            Your seek stays active for 2 hours. Drivers whose route passes
            near yours will see you on the live board.
          </p>
        </div>
